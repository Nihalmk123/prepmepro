...
<aside class="sidebar" id="sidebar" aria-label="Mobile navigation" aria-hidden="true">
  ...
  <nav class="sidebar-nav" role="navigation">
    <a href="index.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span>
      Home
    </a>
    <a href="competitive-exams.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></span>
      Competitive Exams
    </a>
    <a href="study-abroad.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg></span>
      Study Abroad
    </a>
    <a href="student-success-core.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></span>
      Success Core
    </a>
    <a href="colleges.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg></span>
      For Colleges
    </a>
    <a href="free-webinars.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><polyline points="8 21 12 17 16 21"/></svg></span>
      Webinars
    </a>
    <a href="blog.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></span>
      Blog
    </a>
    <a href="news-media.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 0-2 2zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6z"/></svg></span>
      News
    </a>
    <a href="about.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg></span>
      About
    </a>
    <a href="contact.html" class="sidebar-link">
      <span class="sidebar-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2A19.8 19.8 0 0 1 3.07 4.18 2 2 0 0 1 5.07 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11l-.86.86a16 16 0 0 0 6.29 6.29l.86-.86a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>
      Contact
    </a>
  </nav>
    ...
    <div class="container">
      <div class="footer-brand-inner">
        ...
        <p class="footer-tagline">
          Your complete student success platform — built in Karnataka,<br class="hide-mobile">
      ...
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <ul class="footer-contact-list">
            <li>
              <span class="fc-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg></span>
              <span>No. 7, 1st Floor, APMC Yard,<br>Sirsi, Karnataka 581401, IN</span>
            </li>
            <li>
              <span class="fc-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></span>
              <a href="mailto:info@prepme.pro">info@prepme.pro</a>
            </li>
            <li>
              <span class="fc-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.77a16 16 0 0 0 6.29 6.29l.86-.86a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>
              <a href="tel:+919606821633">+91 96068 21633</a>
            </li>
            <li>
              <span class="fc-icon"><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.122.554 4.118 1.523 5.85L0 24l6.335-1.502A11.956 11.956 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.006-1.368l-.36-.214-3.724.883.936-3.619-.235-.372A9.817 9.817 0 012.182 12C2.182 6.57 6.57 2.182 12 2.182S21.818 6.57 21.818 12 17.43 21.818 12 21.818z"/></svg></span>
  ...
  /* ── MODAL — iframe version with W2_Webinar hidden source ── */
  const modalHTML = `
<div id="webinarModal" class="wm-overlay" aria-hidden="true">
  <div class="wm-dialog">
    ...
    <div id="modalFormView">
      ...
      <!-- RIGHT PANEL — iframe replaces the manual form -->
      <div class="wm-right">
    ...
    <div id="modalSuccessView" class="wm-success" style="display:none;">
      ...
      <p class="wm-success-sub">Your seat has been reserved. Check your WhatsApp for confirmation.</p>
...
/* ══════════════════════════════════════════
   IFRAME — inject W2_Webinar + detect success
   ══════════════════════════════════════════ */
...
function _bindIframe() {
  ...
  // Inject source field when iframe finishes loading
  iframe.addEventListener("load", () => {

    // Method 1 — postMessage (works cross-origin if Frappe listens)
    try {
    ...
    // Method 2 — direct DOM injection (works if same-origin)
    try {
      const iDoc = iframe.contentDocument || iframe.contentWindow.document;
      const src  = iDoc.querySelector('[data-fieldname="source"] select, [name="source"], input[name="source"]');
      if (src) {
        src.value = "W2_Webinar";
        src.dispatchEvent(new Event("change", { bubbles: true }));
      }
    } catch (e) {}
  });

  // Detect success by polling iframe URL (Frappe redirects on save)
  const successPoller = setInterval(() => {
    try {
      const url = iframe.contentWindow.location.href;
      if (url.includes("thank-you") || url.includes("success") || url.includes("/w3?")) {
        clearInterval(successPoller);
        showSuccessPage();
      }
    } catch (e) {
      // cross-origin block — ignore until redirect resolves
    }
  }, 800);
...
function openWebinarModal() {
  ...
  // Bind iframe logic once modal is open and iframe is in DOM
  _bindIframe();
}
...
/* ══════════════════════════════════════════
   GLOBAL DELEGATED EVENTS — bound ONCE only
   ══════════════════════════════════════════ */
...
function bindGlobalEvents() {
  ...
  document.addEventListener("click", function (e) {
    ...
    if (e.target.closest(".js-close-webinar-modal")) {
      e.preventDefault();
      closeWebinarModal();
      return;
    }
